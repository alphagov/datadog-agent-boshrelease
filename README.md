...
bosh upload release releases/datadog-agent/datadog-agent-1.yml
```
...
Where `- datadog-agent` means you wish to use an existing security group called `datadog-agent`.
